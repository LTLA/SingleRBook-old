...
Another application of *[SingleR](https://bioconductor.org/packages/3.12/SingleR)* involves using one single-cell dataset 
as a reference to annotate other single-cell datasets.
...
other attached packages:
 [1] scran_1.17.1                SingleR_1.3.5              
 [3] scater_1.17.3               ggplot2_3.3.1              
 [5] scRNAseq_2.3.4              SingleCellExperiment_1.11.4
 [7] SummarizedExperiment_1.19.5 DelayedArray_0.15.1        
