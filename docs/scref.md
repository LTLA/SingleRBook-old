...
Another application of *[SingleR](https://bioconductor.org/packages/3.12/SingleR)* involves using one single-cell dataset as a reference to annotate others.
...
Here, we will use two human pancreas scRNA-seq datasets from the *[scRNAseq](https://bioconductor.org/packages/3.12/scRNAseq)* package.
...
[13] IRanges_2.23.4              S4Vectors_0.27.6           
